    ...
    >
      <defs>
        <linearGradient id="neonGradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style={{ stopColor: 'hsl(0, 50%, 40%)' }} />
          <stop offset="100%" style={{ stopColor: 'hsl(140, 40%, 30%)' }} />
        </linearGradient>
        <filter id="glow">
      ...
      <g transform="translate(35, 50)" filter="url(#glow)">
        ...
        {/* Star sparkles */}
        <use href="#star-sparkle" x="-35" y="-35" width="10" height="10" className="text-red-300 opacity-80 animate-pulse" style={{ animationDelay: '0.2s' }} />
        <use href="#star-sparkle" x="20" y="25" width="8" height="8" className="text-green-200 opacity-70 animate-pulse" style={{ animationDelay: '0.5s' }} />
        <use href="#star-sparkle" x="28" y="-15" width="12" height="12" className="text-red-400 opacity-90 animate-pulse" />
